...
<div
	class="border-borderColor/26 flex h-full w-44 flex-col justify-between rounded-lg border p-2 shadow-sm transition hover:scale-[1.01] hover:border-mainPurple hover:shadow-md md:w-60"
>
	<div title="product" class=" relative flex aspect-square max-h-40 justify-center py-1">
		<img loading="lazy" src={product.imagelink} alt="produktbilde" />
		<img
			loading="lazy"
	...
	<a href="/produkt/{product.id}" class="absolute z-0 h-full w-full" title="Gå til produkt" target="_blank" />
</div>
